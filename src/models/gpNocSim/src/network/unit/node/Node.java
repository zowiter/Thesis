package network.unit.node;

import network.unit.switches.Switch;
import network.unit.switches.buffer.InputVCBuffer;
...
import network.traffic.NodeTraffic;        
...
public class Node {
     ...
     * channel.</li>
     * <li>network.traffic.Flits lastServiceTime statistical field is updated by current clock
     * cycle</li>
     * <li>network.traffic.Flits virtual channel number is updated by the number found from
     * messageVCIndex[].</li>
