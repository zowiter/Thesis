...
public interface Switch {
     ...
     * @see network.unit.switches.buffer.InputVCBuffer#addBufferData(network.traffic.Flit,int,int)
     */
     ...
     * @param curCycle simulation cycle
     * @return true-if flit can be added, false-otherwise.
     * @see network.unit.switches.link.OutputLinkController#addOutputBufferData(Flit,int,int)
     */
     ...
     * @see network.unit.switches.router.Router#determineRoute(int,int,int)
     */
     ...
     * @see network.unit.switches.link.InputLinkController#setOutPathRequest(int)
     */
