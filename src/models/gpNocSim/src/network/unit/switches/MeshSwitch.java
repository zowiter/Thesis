...
import network.unit.switches.router.MeshRouter;
import network.unit.switches.router.TorusRouter;
 ...
 * four adjacent node. Connection with four node provides better throughput.
 *
 * @version 1.0
 */
...
public class MeshSwitch implements Switch {
    ...
    /**
     * This is the array of network.unit.switches.MeshSwitch used to store the list of reference of
     ...
     * node reference is retrieved from the nodeList.
     */
    ...
    /**
     * Constructor of the network.unit.switches.MeshSwitch used for mesh and torus topology. The
     ...
     * @see network.Network#createMeshNetwork()
     */
    public MeshSwitch(int pLink, int vLink, int address, int noOfAdjNode,
        ...
        if (IConstants.TRACE) {
            try {
                ...
                raf.seek(raf.length());
                raf.writeBytes("\nCreated Mesh/Torus network.unit.switches.Switch address = "
                        + this.address);
                raf.close();
    ...
    /**
     * Assigns a network.unit.switches.MeshSwitch reference to which this network.unit.switches.MeshSwitch is connected.
     *
     * @param meshSwitch adjacent switch reference
     ...
     * implemented by simply calling the corresponding input link controller
