 ...
 * uniform distribution using {@link Random}.
 * <p/>
...
public class HelpingUtility {
    ...
    public String getFilePath(String fileName){
        return getClass().getClassLoader().getResource("").getPath() + "/text/" + fileName;
    }
    ...
    public void readParameterFromFile(String parameterFile) {
        ...
        try(InputStream inputStream = new FileInputStream( parameterFile);
            InputStreamReader streamReader = new InputStreamReader(inputStream, StandardCharsets.UTF_8);
            BufferedReader paramReader = new BufferedReader(streamReader)) {
